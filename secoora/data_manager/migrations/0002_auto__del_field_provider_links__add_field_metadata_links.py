...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Provider.links'
        db.delete_column('data_manager_provider', 'links')

        # Adding field 'Metadata.links'
        db.add_column('data_manager_metadata', 'links',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Provider.links'
        db.add_column('data_manager_provider', 'links',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Metadata.links'
        db.delete_column('data_manager_metadata', 'links')
