...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('data_manager_place', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Adding field 'Observation.display_name'
        db.add_column('data_manager_observation', 'display_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Observation.name'
        db.alter_column('data_manager_observation', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'ProjectName.name'
        db.alter_column('data_manager_projectname', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Funding.name'
        db.alter_column('data_manager_funding', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
    def backwards(self, orm):

        # Changing field 'Place.name'
        db.alter_column('data_manager_place', 'name', self.gf('django.db.models.fields.TextField')())
        # Deleting field 'Observation.display_name'
        db.delete_column('data_manager_observation', 'display_name')


        # Changing field 'Observation.name'
        db.alter_column('data_manager_observation', 'name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'ProjectName.name'
        db.alter_column('data_manager_projectname', 'name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Funding.name'
        db.alter_column('data_manager_funding', 'name', self.gf('django.db.models.fields.TextField')())
    models = {
